...
const List<Reciter> kReciters = [
  ...
  Reciter(id: 'aldossari', nameAr: 'ياسر الدوسري', nameEn: 'Yasser Al-Dossari', subfolder: 'Dussary_128kbps'),
  ...
  Reciter(id: 'abdulbasit', nameAr: 'عبد الباسط عبد الصمد', nameEn: 'Abdul Basit', subfolder: 'Abdul_Basit_Murattal_64kbps'),
  Reciter(id: 'alshuraim', nameAr: 'سعود الشريم', nameEn: 'Saud Al-Shuraim', subfolder: 'Shuraym_128kbps'),
