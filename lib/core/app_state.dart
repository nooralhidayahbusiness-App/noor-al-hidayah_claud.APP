...
'challengeQuestionOf': 'سؤال',
'challengeCorrect': 'إجابة صحيحة! 🎉',
'challengeWrong': 'إجابة خاطئة ❌',
'challengeResult': 'النتيجة',
'challengeGreatJob': 'أحسنت! 🎉',
'challengeKeepTrying': 'حاول مرة أخرى غداً 💪',
'challengeBack': 'العودة',
'challengeDoneToday': 'أكملت تحدي اليوم!',
'challengeComeBack': 'عد غداً لتحدٍّ جديد',
'challengeDone': 'تم اليوم ✓',
'challengeAlreadyPlayed': 'أكملت تحدي اليوم، عد غداً',
'exitChallenge': 'الخروج من التحدي؟',
'exitChallengeBody': 'سيُلغى تقدمك الحالي في هذا التحدي.',
'exit': 'خروج',
};
...
'challengeQuestionOf': 'Question',
'challengeCorrect': 'Correct! 🎉',
'challengeWrong': 'Wrong ❌',
'challengeResult': 'Result',
'challengeGreatJob': 'Great job! 🎉',
'challengeKeepTrying': 'Try again tomorrow 💪',
'challengeBack': 'Back',
'challengeDoneToday': "Today's challenge is done!",
'challengeComeBack': 'Come back tomorrow for a new challenge',
'challengeDone': 'Done today ✓',
'challengeAlreadyPlayed': "You've completed today's challenge",
'exitChallenge': 'Exit challenge?',
'exitChallengeBody': 'Your current progress will be lost.',
'exit': 'Exit',
};
